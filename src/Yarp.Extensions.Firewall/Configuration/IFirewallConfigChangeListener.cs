...
public interface IFirewallConfigChangeListener
{
    ...
    public void ConfigurationLoadingFailed(IFirewallConfigProvider configProvider, Exception exception);
    ...
    /// <param name="exception">The thrown exception.</param>
    public void ConfigurationApplyingFailed(IReadOnlyList<IFirewallConfig> firewallConfigs, Exception exception);
